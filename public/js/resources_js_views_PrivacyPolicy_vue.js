...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    getPrivacyPolicyData: function getPrivacyPolicyData() {// api
    ...
    [
      ...
      _c("div", { staticClass: "section-gap bg-white" }, [
        _c("div", { staticClass: "container" }, [
          _c(
            "div",
            { staticClass: "privacy-page" },
            _vm._l(_vm.policylist, function(policy, key) {
              return _c(
                "div",
                { key: key, staticClass: "emb-card mb-12 pa-6" },
                [
                  _c("h4", { staticClass: "mb-4" }, [
                    _vm._v(_vm._s(policy.name))
                  ]),
                  _vm._v(" "),
                  _c("div", { domProps: { innerHTML: _vm._s(policy.content) } })
                ]
              )
            }),
            0
