<template>
	<div class="sidebar-panel">
		<v-layout justify-end mt-0>
			...
			>
				Show Order Detail :<emb-currency-sign></emb-currency-sign>{{productTotal}}
			</v-btn>
		</v-layout>
				...
				<div v-else class="cart-shop-list">
					...
					<div class="pt-6 px-4">
						<div class="layout align-center justify-space-between ma-0">
							<p>Subtotal</p>
							<span><emb-currency-sign></emb-currency-sign>{{productTotal}}</span>
						</div>
						<div class="layout align-center justify-space-between ma-0">
							<p>Shipping</p>
						...
						<div class="layout align-center justify-space-between ma-0">
							<h4>Total</h4>
							<h4><emb-currency-sign></emb-currency-sign>{{totalPrice}}</h4>
						</div>
						<v-divider class="my-4"></v-divider>
					</div>
       ...
       mounted() {
		...
		methods: {
            ...
            onDeleteProductFromCart() {
                ...
                console.log(this.selectDeletedProduct);
