									...
									<v-flex xs2 sm2 md2 lg2 xl2 product-gallery>
										...
										>
											<a href="javascript:void(0)">
												<img :src="productItemImg.image_url" width="71" height="91" alt="product image">
											</a>
										</div>
									</v-flex>
...
<!--								<emb-review-popup ref="productReviewPopup"></emb-review-popup>-->
								<h4 class="accent--text"><emb-currency-sign></emb-currency-sign>{{selectedProduct.sell_price.toFixed(2)}}</h4>
...
<!--										</v-flex>-->
								...
								<div class="mb-6 btn-wrap">
									...
									<v-btn large  @click="buyNow(selectedProduct)" class="white buyProduct cpx-0">Buy Now</v-btn>
                                    ...
                                    <v-row>
                                        <v-col cols="12">
                                            ...
                                            <v-chip
                                                ...
                                                text-color="white"
                                            >
                                                Estimated Commissions: <emb-currency-sign></emb-currency-sign>  {{(this.selectedProduct.sell_price * this.selectedProduct.selling_margin/100).toFixed(2)}}
                                            </v-chip>
                                        </v-col>
                                        <v-col cols="12">
                        ...
                        <template class="mt-5">
                            ...
                            <v-tabs-items v-model="model">
                                ...
                                >
                                    <v-card flat >
                                        <v-card-text style="justify-content: center" v-html="selectedProduct.description">
